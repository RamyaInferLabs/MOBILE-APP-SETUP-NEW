...
const SubscriptionCard = ({name,currency,icon,price,billing,color,category,plan, renewalDate , expanded, onPress,paymentMethod, startDate,status} : SubscriptionCardProps) => {
  return (
